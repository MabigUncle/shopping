    ...
    <div>
        <el-form ref="form" label-width="80px">
            ...
            <el-form-item label="SKU名称" size="normal">
                <el-input placeholder="请输入名称" size="normal" clearable @change="" v-model="skuInfo.skuName"></el-input>
            </el-form-item>
            <el-form-item label="价格(元)" type="number">
                <el-input placeholder="价格(元素)" clearable @change="" v-model="skuInfo.price"></el-input>
            </el-form-item>
            <el-form-item label="重量(千克)">
                <el-input placeholder="重量(千克)" clearable @change="" v-model="skuInfo.weight"></el-input>
            </el-form-item>
